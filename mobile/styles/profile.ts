...
export const profileSettingsStyles = StyleSheet.create({
    ...
    deleteSectionDivider: { height: 1, backgroundColor: "#e5e7eb", marginTop: 20, marginBottom: 16 },
    deleteTitle: { fontSize: 16, fontWeight: "700", color: "#b91c1c", marginBottom: 6 },
    deleteHint: { color: "#6b7280", fontSize: 13, marginBottom: 10 },
    deleteButton: { backgroundColor: "#dc2626", borderRadius: 10, ...center, paddingVertical: 12 },
    deleteButtonText: { color: color.white, fontWeight: "600", fontSize: 14 },
    ...
    deleteSuccessCard: { backgroundColor: color.white, borderRadius: 12, padding: 16, width: "82%", maxWidth: 360 },
