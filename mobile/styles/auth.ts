...
export const authFormStyles = StyleSheet.create({
    ...
    titleRow: { width: "100%", maxWidth: 360, position: "relative", alignItems: "center", justifyContent: "center", marginBottom: 20, zIndex: 40, elevation: 40 },
    titleNoBottomMargin: { marginBottom: 0 },
    titleLanguageMenuWrap: { position: "absolute", right: 0, top: 2, zIndex: 50, elevation: 50 },
    titleLanguageIconButton: { width: 28, height: 28, borderRadius: 14, borderWidth: 1, borderColor: color.border, backgroundColor: color.white, alignItems: "center", justifyContent: "center" },
    titleLanguageDropdown: {
        position: "absolute",
        top: 34,
        right: 0,
        zIndex: 60,
    ...
    titleLanguageDropdownItem: { paddingVertical: 9, paddingHorizontal: 12 },
    titleLanguageDropdownItemActive: { backgroundColor: "#eff6ff" },
    titleLanguageDropdownItemText: { color: "#334155", fontSize: 13, fontWeight: "500" },
    titleLanguageDropdownItemTextActive: { color: color.blue, fontWeight: "700" },
    inputTopGap: { marginTop: 12 },
    inputError: { borderColor: "#dc2626", borderWidth: 1.5 },
    inputValid: { borderColor: "#16a34a", borderWidth: 1.5 },
    inputChecking: { borderColor: "#eab308", borderWidth: 1.5 },
